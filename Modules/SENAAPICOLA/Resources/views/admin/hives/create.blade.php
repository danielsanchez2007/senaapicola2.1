            ...
            <div class="col-12 col-lg-8 col-xl-7">
                <div class="form-card">
                    ...
                    <div class="card-header text-center">
                        ...
                        <h3 class="fw-bold mb-1">Registrar Nueva Colmena</h3>
                        <p class="opacity-75 mb-0">Ingresa los datos de la colmena para su seguimiento y trazabilidad</p>
                    </div>
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('senaapicola.admin.hives.store') }}" method="POST">
                            ...
                            <div class="mb-5">
                                <label class="form-label">Seleccionar Apiario</label>
                            ...
                            <div class="d-flex gap-3 mt-4">
                                <button type="submit" class="btn btn-save flex-grow-1">
                                    <i class="fas fa-save me-2"></i> Guardar Colmena
                                </button>
                    ...
                    <div class="card-footer bg-transparent border-0 text-center py-4 small text-white-50">
                        Los datos ingresados serán visibles en el mapa de apiarios y en el monitoreo general.
                    </div>
                </div>
            </div>
        </div>
