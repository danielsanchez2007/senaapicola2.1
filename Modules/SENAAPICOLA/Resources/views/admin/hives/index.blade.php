            ...
            <div class="col-12">
                <div class="main-card">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex gap-3">
                                <a href="{{ route('senaapicola.admin.hives.create') }}" class="btn btn-sena">
                                    <i class="fas fa-plus-circle me-2"></i> Nueva Colmena
                                </a>
                                <a href="{{ route('senaapicola.admin.hives.report', ['apiary_id' => request('apiary_id')]) }}" 
                    ...
                    <div class="card-body p-5">
                        ...
                        <!-- Filtro -->
                        <form method="GET" action="{{ route('senaapicola.admin.hives.index') }}" class="mb-5">
                                ...
                                <select name="apiary_id" class="form-select apiary-filter w-auto" onchange="this.form.submit()">
                                    ...
                                    @foreach($apiaries as $apiary)
                                        <option value="{{ $apiary->id }}" 
                                            {{ request('apiary_id') == $apiary->id ? 'selected' : '' }}>
                                            {{ $apiary->name }}
                                        </option>
                                    @endforeach
                                </select>
                                    ...
                                    <tbody id="hiveTableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{ route('senaapicola.admin.hives.edit', $hive->id) }}" 
                                                       class="btn btn-warning btn-sm px-3" title="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('senaapicola.admin.hives.destroy', $hive->id) }}" 
                                                          method="POST" style="display: inline;" 
                                                          onsubmit="return confirm('¿Eliminar esta colmena definitivamente?')">
                                                        @csrf
                                                        @method('DELETE')
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5">
                                                ...
                                                <p class="lead text-muted">No hay colmenas registradas aún</p>
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
