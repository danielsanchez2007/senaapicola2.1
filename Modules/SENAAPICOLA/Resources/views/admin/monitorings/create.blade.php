                ...
                <div class="form-card">
                    ...
                    <div class="card-header">
                        ...
                        <p class="opacity-80 small mb-0">
                            Registra una visita o monitoreo de apiario / colmena
                        </p>
                    </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="user_nickname" name="user_nickname" class="form-select" required>
                                        ...
                                        @php $userRole = $user->roles->first()?->slug ?? ''; @endphp
                                        @if(in_array($userRole, ['senaapicola.admin', 'senaapicola.intern']))
                                        <option value="{{ $user->nickname }}" data-role="{{ $userRole }}">
                                            {{ $user->nickname }}
                                        </option>
                                        @endif
                                        @endforeach
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" rows="4" class="form-control" 
                                        placeholder="Ej: Inspección sanitaria, observación de actividad, recolección de miel..."></textarea>
                                </div>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-0 text-center py-4 small text-white-50">
                        El seguimiento quedará registrado en el historial del apiario seleccionado.
                    </div>
                </div>
            </div>
        </div>
