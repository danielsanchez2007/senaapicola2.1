        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 text-right d-flex justify-content-end align-items-center gap-2">
                            <a href="{{ route('senaapicola.admin.productions.create_exit') }}" class="btn btn-light btn-sm text-dark">
                                <i class="fas fa-plus-circle mr-1"></i> Nuevo Registro Salida
                            </a>
                            <a href="{{ route('senaapicola.admin.movements.report.all') }}" class="btn btn-danger btn-sm">
                ...
                <div class="card-body text-center">
                    <a href="{{ route('senaapicola.admin.movements.bodega') }}" class="btn btn-success btn-lg m-3">
                        <i class="fas fa-warehouse"></i> Entradas (Bodega)
                    </a>
                    <a href="{{ route('senaapicola.admin.movements.agroindustria') }}" class="btn btn-warning btn-lg m-3 text-white">
