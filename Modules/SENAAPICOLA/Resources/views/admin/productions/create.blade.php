            ...
            <div class="col-12 col-lg-10 col-xl-8">
                <div class="form-card">
                    ...
                    <div class="card-header">
                        <div class="mb-4">
                            <i class="fas fa-plus-circle fa-4x glow-gold"></i>
                        </div>
                        <h3 class="fw-bold mb-2">Registrar Producción</h3>
                        <p class="opacity-80 small mb-0">
                            Ingresa un nuevo registro de entrada o salida de producción
                        </p>
                    </div>

                    <div class="card-body p-5">
                        <form action="{{ route('senaapicola.admin.productions.store') }}" method="POST" id="productionForm">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="apiary_id" id="apiary_id" class="form-select" required>
                                        ...
                                        @endforeach
                                        <option value="">Sin Apiario</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="product" class="form-control" 
                                           value="{{ old('product') }}" placeholder="Ej: Miel de abeja" required>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="action" id="action" class="form-select" required onchange="updateDestination()">
                                        <option value="entry" {{ old('action') == 'entry' ? 'selected' : '' }}>Entrada (Producción)</option>
                                        <option value="exit" {{ old('action') == 'exit' ? 'selected' : '' }}>Salida</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="destination_or_origin" id="hidden_destination" value="Bodega">
                                </div>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-0 text-center py-4 small text-white-50">
                        El registro se reflejará en el historial de producción y estadísticas.
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    // Función para actualizar destino/origen según el tipo de movimiento
