            ...
            <div class="col-12 col-lg-10 col-xl-8">
                <div class="form-card">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('senaapicola.admin.productions.store_exit') }}" method="POST" id="exitForm">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="destination_or_origin" id="destination_or_origin" class="form-select" required>
                                        <option value="">— Seleccione un destino —</option>
                                        <option value="Agroindustria" {{ old('destination_or_origin') == 'Agroindustria' ? 'selected' : '' }}>Agroindustria</option>
                                        <option value="Venta Directa" {{ old('destination_or_origin') == 'Venta Directa' ? 'selected' : '' }}>Venta Directa</option>
                                        <option value="Consumo Interno" {{ old('destination_or_origin') == 'Consumo Interno' ? 'selected' : '' }}>Consumo Interno</option>
                                        <option value="Otro" {{ old('destination_or_origin') == 'Otro' ? 'selected' : '' }}>Otro</option>
                                    </select>
                                </div>
                            </div>
...
<script>
    ...
    // Función updateDestination (mantenida por compatibilidad aunque no es necesaria aquí)
    function updateDestination() {
        // No hace nada porque el tipo está fijo como "exit"
    }
</script>
@endpush