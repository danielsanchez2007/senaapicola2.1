        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 text-right d-flex justify-content-end align-items-center gap-2">
                            <a href="{{ route('senaapicola.admin.productions.create') }}" class="btn btn-light btn-sm text-dark mr-2">
                                <i class="fas fa-plus-circle mr-1"></i> Nuevo Registro
                            </a>
                            <a href="{{ route('senaapicola.admin.productions.create_exit') }}" class="btn btn-warning btn-sm text-dark mr-2">
                ...
                <div class="card-body">
                    ...
                    {{-- Filtro por apiario --}}
                    <form method="GET" action="{{ route('senaapicola.admin.productions.index') }}" class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('senaapicola.admin.productions.edit', $p->id) }}" class="btn btn-warning btn-sm" title="Editar">
