            ...
            <div class="col-12">
                <div class="main-card">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-end d-flex justify-content-end gap-3">
                                <a href="{{ route('senaapicola.admin.productions.create') }}" class="btn btn-sena">
                                    <i class="fas fa-plus-circle me-2"></i> Nuevo Registro (Entrada)
                                </a>
                                <a href="{{ route('senaapicola.admin.productions.create_exit') }}" class="btn btn-warning">
                    ...
                    <div class="card-body p-5">
                        ...
                        <!-- Filtro por Apiario -->
                        <form method="GET" action="{{ route('senaapicola.admin.productions.index') }}" class="mb-4">
                                    ...
                                    <tbody id="productionTableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{ route('senaapicola.admin.productions.edit', $p->id) }}" 
