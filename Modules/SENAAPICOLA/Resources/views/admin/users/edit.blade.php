            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="form-card">
                    ...
                    <div class="card-header">
                        <div class="mb-4">
                            <i class="fas fa-user-edit fa-4x glow-gold"></i>
                        </div>
                        <h3 class="fw-bold mb-2">Editar Usuario</h3>
                        <p class="opacity-80 small mb-0">
                            Modifica los datos del usuario y su rol en el sistema SENA APICOLA
                        </p>
                    </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <!-- Información actual -->
                        <div class="current-info mb-5">
                            <h6 class="fw-bold mb-3"><i class="fas fa-info-circle me-2"></i> Información actual del usuario</h6>
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <form action="{{ route('senaapicola.admin.users.update', $user->id) }}" method="POST">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Nueva Contraseña <small class="text-white-50">(dejar en blanco para mantener la actual)</small></label>
                                ...
                                <div class="col-12">
                                    ...
                                    <small class="form-text text-white-50">Solo llenar si desea cambiar la contraseña.</small>
                                </div>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-0 text-center py-4 small text-white-50">
                        Los cambios se aplicarán inmediatamente. La contraseña solo se actualizará si se proporciona una nueva.
                    </div>
                </div>
            </div>
        </div>
