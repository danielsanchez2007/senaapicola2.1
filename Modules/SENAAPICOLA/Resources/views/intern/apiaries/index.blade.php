                ...
                <div class="card-header bg-primary text-white">
                    <div class="row w-100">
                        <div class="col-md-6 d-flex align-items-center">
                            <h5 class="mb-0">Listado de Apiarios - Vista de Pasante</h5>
                        </div>
                        <div class="col-md-6 text-right d-flex justify-content-end align-items-center gap-2">
                            <a href="{{ route('senaapicola.intern.apiaries.report') }}" class="btn btn-danger btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('senaapicola.intern.apiaries.show', $apiary->id) }}" class="btn btn-info btn-sm" title="Ver Detalles">
