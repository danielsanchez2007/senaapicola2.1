        ...
        <div class="col-12 col-lg-10 col-xl-8">
            <div class="form-card">
                <div class="card-header">
                    <div class="mb-4">
                        <i class="fas fa-hive fa-4x glow-gold"></i>
                    </div>
                    <h3 class="fw-bold mb-2">Registrar Nueva Colmena</h3>
                    <p class="opacity-75 small mb-0">Ingresa los datos de la colmena para su seguimiento y trazabilidad</p>
                </div>
                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('senaapicola.intern.hives.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="name" class="form-label">Nombre de la Colmena <span class="text-danger">*</span></label>
                                <input type="text"
                            ...
                            <div class="col-md-6">
                                <label for="apiary_id" class="form-label">Apiario <span class="text-danger">*</span></label>
                                <select class="form-select @error('apiary_id') is-invalid @enderror"
                                        id="apiary_id"
                                        name="apiary_id"
                                        required>
                        ...
                        <div class="d-flex gap-3 mt-5">
                            <button type="submit" class="btn btn-save flex-grow-1">
                                <i class="fas fa-save me-2"></i> Registrar Colmena
                            </button>
                            <a href="{{ route('senaapicola.intern.hives.index') }}" class="btn btn-cancel flex-grow-1 text-center">
                ...
                <div class="card-footer bg-transparent border-0 text-center py-4 small text-white-50">
                    La colmena quedará vinculada al apiario seleccionado.
                </div>
            </div>
        </div>
    </div>
