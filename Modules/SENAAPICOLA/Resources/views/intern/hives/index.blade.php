        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 text-right d-flex justify-content-end align-items-center gap-2">
                            <a href="{{ route('senaapicola.intern.hives.create') }}" class="btn btn-light btn-sm text-dark">
                                <i class="fas fa-plus-circle mr-1"></i> Nueva Colmena
                            </a>
                            <a href="{{ route('senaapicola.intern.hives.report') }}" class="btn btn-danger btn-sm">
                ...
                <div class="card-body">
                    ...
                    {{-- Filtro por apiario --}}
                    <form method="GET" action="{{ route('senaapicola.intern.hives.index') }}" class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('senaapicola.intern.hives.edit', $hive->id) }}" class="btn btn-warning btn-sm" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('senaapicola.intern.hives.destroy', $hive->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('¿Está seguro de que desea eliminar esta colmena?')">
                                                @csrf
                                                @method('DELETE')
