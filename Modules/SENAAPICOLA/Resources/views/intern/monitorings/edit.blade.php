...
<div class="container pt-4">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('senaapicola.intern.monitorings.update', $monitoring->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @php
                        $readableRole = $monitoring->role === 'senaapicola.admin' ? 'Administrador del Sistema' :
                ...
                <a href="{{ route('senaapicola.intern.monitorings.index') }}" class="btn btn-secondary">Cancelar</a>
            </form>
        </div>
    </div>
</div>
