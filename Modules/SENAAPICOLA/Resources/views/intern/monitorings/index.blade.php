        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 text-right d-flex justify-content-end align-items-center gap-2">
                            <a href="{{ route('senaapicola.intern.monitorings.create') }}" class="btn btn-light btn-sm text-dark">
                                <i class="fas fa-plus-circle mr-1"></i> Agregar Seguimiento
                            </a>
                            <a href="{{ route('senaapicola.intern.monitorings.report') }}" class="btn btn-danger btn-sm">
                ...
                <div class="card-body">
                    ...
                    {{-- Filtro por apiario --}}
                    <form method="GET" action="{{ route('senaapicola.intern.monitorings.index') }}" class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('senaapicola.intern.monitorings.edit', $m->id) }}" class="btn btn-warning btn-sm" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('senaapicola.intern.monitorings.destroy', $m->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('¿Está seguro de que desea eliminar este seguimiento?')">
                                                @csrf
                                                @method('DELETE')
