            ...
            <div class="col-12">
                <div class="main-card">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-end d-flex justify-content-end gap-3">
                                <a href="{{ route('senaapicola.intern.monitorings.create') }}" class="btn btn-sena">
                                    <i class="fas fa-plus-circle me-2"></i> Agregar Seguimiento
                                </a>
                                <a href="{{ route('senaapicola.intern.monitorings.report') }}" class="btn btn-danger">
                    ...
                    <div class="card-body p-5">
                        ...
                        <!-- Filtro por Apiario -->
                        <form method="GET" action="{{ route('senaapicola.intern.monitorings.index') }}" class="mb-4">
                                        ...
                                        @forelse($monitorings as $m)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('senaapicola.intern.monitorings.edit', $m->id) }}"
                                                           class="btn btn-warning btn-sm px-3" title="Editar">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('senaapicola.intern.monitorings.destroy', $m->id) }}"
