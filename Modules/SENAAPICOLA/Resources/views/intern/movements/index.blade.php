            ...
            <div class="main-card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-end">
                            <a href="{{ route('senaapicola.intern.movements.report') }}" class="btn btn-sena btn-sm">
                ...
                <div class="card-body p-5">
                    <div class="d-flex flex-wrap justify-content-center gap-3 mb-5">
                        <a href="{{ route('senaapicola.intern.movements.bodega') }}" class="btn btn-sena">
                            <i class="fas fa-warehouse me-2"></i> Entradas (Bodega)
                        </a>
                        <a href="{{ route('senaapicola.intern.movements.agroindustria') }}" class="btn btn-sena">
