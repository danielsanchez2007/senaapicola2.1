        ...
        <div class="col-12 col-lg-10 col-xl-8">
            <div class="form-card">
                <div class="card-header">
                    <div class="mb-4">
                        <i class="fas fa-boxes fa-4x glow-gold"></i>
                    </div>
                    <h3 class="fw-bold mb-2">Registrar Entrada de Producción</h3>
                    <p class="opacity-75 small mb-0">Ingresa un registro para actualizar el inventario</p>
                </div>

                <div class="card-body p-5">
                    <form action="{{ route('senaapicola.intern.productions.store') }}" method="POST" id="productionEntryForm">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label for="action" class="form-label">Tipo</label>
                                <select name="action" id="action" class="form-select" required onchange="updateDestination()">
                                    <option value="entry" selected>Entrada</option>
                                </select>
                            </div>
                ...
                <div class="card-footer bg-transparent border-0 text-center py-4 small text-white-50">
                    La entrada se reflejará en los reportes y movimientos del sistema.
                </div>
            </div>
        </div>
    </div>
