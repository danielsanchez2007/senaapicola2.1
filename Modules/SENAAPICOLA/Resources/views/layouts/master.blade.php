            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="{{ route('senaapicola.admin.welcome') }}" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.apiaries.create') }}" class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon text-info"></i>
                                        <p>Registrar Apiario</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.apiaries.index') }}" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.hives.create') }}" class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon text-info"></i>
                                        <p>Ingreso</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.hives.index') }}" class="nav-link">
                                        <i class="fas fa-list-ul nav-icon text-primary"></i>
                                        <p>Listas</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.productions.create') }}" class="nav-link">
                                        <i class="fas fa-plus-circle nav-icon text-info"></i>
                                        <p>Ingreso</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.productions.create_exit') }}" class="nav-link">
                                        <i class="fas fa-door-open nav-icon text-warning"></i>
                                        <p>Salida</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.productions.index') }}" class="nav-link">
                                        <i class="fas fa-list-ul nav-icon text-primary"></i>
                                        <p>Listas</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.users.create') }}" class="nav-link">
                                        <i class="fas fa-user-edit nav-icon text-info"></i>
                                        <p>Registro</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('senaapicola.admin.users.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('senaapicola.admin.profile.edit') }}" class="nav-link">
