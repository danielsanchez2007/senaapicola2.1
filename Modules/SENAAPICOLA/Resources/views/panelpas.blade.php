                ...
                <div class="main-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                <h1 class="fw-bold display-4 mb-2 glow-gold">
                                    <i class="fas fa-user-graduate me-3"></i> Bienvenido, Pasante
                                </h1>
                                <p class="lead opacity-90 mb-0">
                                    Consulta general y mapa de apiarios del programa Sena Apícola
                                </p>
                            </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row g-4 mb-5">
                            ...
                            <div class="col-md-4">
                                <div class="stat-card text-white">
                                    <i class="fas fa-tasks fa-3x mb-3" style="color: var(--sena-orange);"></i>
                                    <h5 class="mb-1">Tareas Asignadas</h5>
                                    <h2 class="fw-bold mb-0">—</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white bg-opacity-10 rounded-3 p-4 border border-white border-opacity-10">
                            <h4 class="fw-bold text-white mb-3">
                                <i class="fas fa-cogs me-2"></i> Funciones del Apartado de Pasante
                            </h4>
                            <p class="lead text-white-80 mb-0">
                                Este módulo te permite realizar el registro y consulta de información operativa 
                                del sistema apícola en los apartados habilitados para pasantes.
                            </p>
                        </div>
