...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Apiarios</title>
    <style>
        body {
...
@endphp
    ...
    <div style="background-color:#e3f2fd; border:1px solid #17a2b8; padding:10px; margin:20px 0; border-radius:5px;">
        ...
        <p style="margin:5px 0; font-size:12px; color:#0c5460;"><strong>Total de apiarios:</strong> {{ $apiaries->count() }}</p>
